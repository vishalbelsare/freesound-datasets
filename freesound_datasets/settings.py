...
if os.getenv('DEPLOY_ENV', 'dev') == 'prod':
    ...
    DEBUG = False
    ALLOWED_HOSTS = ['localhost', 'asplab-web1', 'asplab-web1.s.upf.edu', 'datasets.freesound.org', 'annotator.freesound.org', 'fsdatasets.mtg.sb.upf.edu', 'fsannotator.upf.edu']
else:
    DEBUG = True
...
PLAYER_LOUDNESS_NORMALIZATION_METHOD = 'ebur128'
PLAYER_LOUDNESS_NORMALIZATION_TARGET = -30.0
PLAYER_LOUDNESS_NORMALIZATION_MAX_RATIO = 3.0
